	...
	\label{sec:Praxistil}
		...
		\section{Realisierung der Schaltung}
			...
			\label{sec:Motorsteuerung}
				...
				Eine Darlington-Schaltung ist eine Schaltung zweier Transistoren mit hoher Stromverstärkung und wird zur Schaltung beziehungsweise Steuerung größerer Lasten eingesetzt. Dabei können die nötigen Steuerströme gering gehalten werden. Der hier verwendete ULN2003 beinhaltet mehrere Darlington-Transistoren in einem 
			...
			\subsection{Anschlagerkennung durch Endschalter}
				%Redundanz, pullUp
			\subsection{Gesamtschaltung und Pinbelegungen}
