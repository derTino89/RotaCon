	...
	\label{sec:Praxistil}
		...
		\section{Verwendete Hardware}
			...
			\label{sec:Motor}
				...
				\begin{figure}[htbp]
					\centering
					\subcaptionbox{Spulenanordnung\protect\footnotemark\label{fig:Spulen}}
					...
					\label{fig:imgMotor}}
				\end{figure}
				\footnotetext[5]{Bildquelle: [Roboticlab\cite{Schrittmotor_Bild}]}
				\footnotetext{Bildquelle: \textcopyright Alexander Hinkel [Arduino-Projekte\cite{Schrittmotor_Getriebe}]}
		\newpage
